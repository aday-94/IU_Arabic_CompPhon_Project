""" L645 ANLP Comp Phon Final Project Fall 2022 Andrew Davis -- List of Regex for Diacritic Transcription in Arabic Tweets ; See Wikipedia for Arabic Diacritics """

import re

IN = open('f2k22data-arbipa-copy.txt', encoding = 'utf-8')
...
def arab_diacritics_ipa(text):
    ...
    #daggeralif = re.compile("") i cant find this fucking sign on its own fuckin a (no pun intended)
    #alifwaslah = re.compile()
    ...
    yehamza = re.compile("ئ", re.VERBOSE)
    ...
    #text = re.sub daggeralif life ya dig skrrt
    #text = re.sub(alifwaslah, )
